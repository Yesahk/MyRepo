    ...
    <div class="container-fluid pt-5">
        <div class="container">
            <div class="text-center pb-2">
                <p class="section-title px-5"><span class="px-2">List of heritage list</span></p>
                <h1 class="mb-4">List of heritage list</h1>
                ...
                <div class="col-lg-12 col-sm-12">
                    <div class="table-responsive">
                        <table class="table table-borederd">
                            ...
                            <?php
                                $dataQ = $coObject->getHeritageList();
                                $rowQ= $coObject->getHeritageList();
                                if ($rowQ > 0) {
                                    $x = 0;
