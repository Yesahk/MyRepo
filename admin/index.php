            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="card">
                      ...
                      <div class="card-body">
                        ...
                        <a href="adduser.php" class="nav-item nav-link active" style="border-radius: 0;">Add user account.</a>
                        <a href="userlist.php" class="nav-item nav-link active" style="border-radius: 0;">List of users.</a>
                ...
                <div class="col-lg-4">
                    <div class="card">
                      ...
                      <div class="card-body">
                        <!-- <h5 class="card-title">Login us Administrator</h5> -->
                        <p class="card-text">Register user account</p>
                        <p class="card-text">Update user account</p>
                        <p class="card-text">Acitive user account</p>
                        <p class="card-text">Deactive user account</p>
                      </div>
                    </div>
                </div>
