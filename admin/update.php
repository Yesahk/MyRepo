    ...
    <div class="container-fluid pt-5">
        <div class="container">
            <div class="text-center pb-2">
                <p class="section-title px-5"><span class="px-2">Update User</span></p>
                ...
                <div class="col-lg-6">
                    <div class="contact-form">
                        ...
                        <form id="forms" action="" method="post">
                            ...
                            <p class="text-primary text-center" style="font-size:14px;"><?=$aObject->UpdateMethod(); ?></p>
                            <div class="control-group">
                                <input type="text" class="form-control" id="name" placeholder="Your name" name="name" value="<?=$_GET['n']; ?>" />
                                <p class="text-danger mt-1" id="error-1" style="font-size:12px;"></p>
                            </div>

                            <div class="control-group">
                                <input type="email" class="form-control" id="email" placeholder="Your Email" name="email" value="<?=$_GET['e']; ?>"/>
                            ...
                            <div class="control-group">
                                ...
                                <p class="text-success mt-1" id="error-get" style="font-size:12px;">recent role : &nbsp;<?=$_GET['r']; ?></p>
                            ...
                            <div>
                                <button class="btn btn-primary py-2 px-4" type="submit" id="updateBtn" style="border-radius: 0;" name="updateBtn">Submit</button>
                            </div>
                        </form>
                    </div>
                </div>
