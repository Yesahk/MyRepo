    ...
    <div class="container-fluid pt-5">
        <div class="container">
            <div class="text-center pb-2">
                <p class="section-title px-5"><span class="px-2">Register Beds / rooms.</span></p>
                ...
                <div class="col-lg-6">
                    <div class="contact-form">
                        ...
                        <form id="forms" action="" method="post">
                            ...
                            <p class="text-primary text-center" style="font-size:14px;"><?=$hrObject->registerRooms(); ?></p>
                            ...
                            <div class="control-group">
                                <input type="number" class="form-control" id="room" placeholder="room number" name="room" />
                            ...
                            <div class="control-group">
                                <select class="form-control" name="types" id="types">
                                    <option value="Choose">Choose Room Type</option>
                            ...
                            <div>
                                <button class="btn btn-primary py-2 px-4" type="submit" id="changeBtn" style="border-radius: 0;" name="regsiterRooms">Submit</button>
                            </div>
                        </form>
                    </div>
                </div>
        ...
        $(document).ready(function() {
            ...
            $("#changeBtn").on('click',function(event) {
                ...
                if(hotelname == ''){
                    ...
                    $("#hotelname").css("border-color","green");
                    $("#hotelname").removeClass("bg-danger");
                    $("#error-2").html('');
                } 
                ...
                if(room == ''){
                    ...
                    $("#room").css("border-color","green");
                    $("#room").removeClass("bg-danger");
                    $("#error-3").html('');
                } 
                ...
                if(types == 'Choose'){
                    event.preventDefault();
                    $("#types").css("border-color","red");
                    $("#types").addClass("bg-danger");
                    ...
                    $("#types").css("border-color","green");
                    $("#types").removeClass("bg-danger");
                    $("#error-5").html('');
                }
