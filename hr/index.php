<?php 
 ...
 require __DIR__.'/hr_class.php';
 $hrObject = new hrClass();

 $dataQ = $hrObject->getDetail($_SESSION['sessionemail']);
 $rowQ = $hrObject->getDetail($_SESSION['sessionemail']);
            ...
            <?php if (isset($_GET['success'])) { ?>
              <div class="row">
                <div class="col-md-12 col-lg-12">
                  <div class="alert alert-success alert-dismissible fade show text-center" role="alert" style="color: #fff; background:#008000; border-radius:0; height:50px;">
                  <strong>Hy, <?= $fullname; ?> !</strong> <?=$_GET['success']?>.
                </div>
                </div>
              </div>
            <?php } ?>
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="card">
                      ...
                      <div class="card-body">
                        <h5 class="card-title">Login as <?=$role; ?></h5>
                        <p class="card-text">Fullname : <?= $fullname; ?></p>
                        <p class="card-text">Email : <?= $email; ?></p>
                        <p class="card-text">Phone : <?= $phone; ?></p>
                        <p class="card-text">Role : <?= $role; ?></p>
                        <p class="card-text">otp : <?= $otp; ?></p>
                        <a href="cp.php" class="btn btn-primary" style="border-radius: 0;">Change Password ?</a>
                      </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4">
                    <div class="card">
                      ...
                      <div class="card-body">
                        <!-- <h5 class="card-title">Login us Administrator</h5> -->
                        <a href="register-room.php" class="nav-item nav-link active" style="border-radius: 0;">Register New room</a>
                        <a href="listof-rooms.php" class="nav-item nav-link active" style="border-radius: 0;">List Rooms</a>
                        <a href="reserved-rooms.php" class="nav-item nav-link active" style="border-radius: 0;">Reserved Rooms</a>
                        <a href="cp.php" class="nav-item nav-link active" style="border-radius: 0;">Change Password ?</a>
                      </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4">
                    <div class="card">
                      ...
                      <div class="card-body">
                        <!-- <h5 class="card-title">Login us Administrator</h5> -->
                        <p class="card-text">Register Room</p>
                        <p class="card-text">View Reserved room</p>
                        <!-- <p class="card-text">Remove rooms</p> -->
