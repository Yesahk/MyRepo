                ...
                <div class="col-lg-12 col-sm-12">
                    <div class="table-responsive">
                        <table class="table table-borederd">
                            ...
                            <?php
                                $dataQ = $hrObject->getMyRooms($_SESSION['sessionemail']);
                                $rowQ= $hrObject->getMyRooms($_SESSION['sessionemail']);
                                if ($rowQ > 0) {
                                    $x = 0;
                                    ...
                                    <tr>
                                       ...
                                       <?php  }else{  ?> 
                                            <input type="submit" name="DeAtive" value="Not Reserved" class="btn btn-primary" style="border-radius:0; height:28px; font-size: 10px;">
                                       <?php } ?>
                                         </td>
                                    </tr>
