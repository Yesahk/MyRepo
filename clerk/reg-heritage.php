    ...
    <div class="container-fluid pt-5">
        <div class="container">
            <div class="text-center pb-2">
                <p class="section-title px-5"><span class="px-2">Register Cultural Heritage</span></p>
                ...
                <div class="col-lg-12">
                    <div class="contact-form">
                        ...
                        <form id="forms" action="" method="post" enctype="multipart/form-data">
                            ...
                            <p class="text-primary text-center" style="font-size:14px;"><?= $cObject->regHeritageMethod(); ?></p>
                           
                           <div class="row">
                           	 <div class="col-lg-4"> 
                           	 	 <div class="control-group">
	                                <input type="text" class="form-control" id="name" placeholder="Heritage Name" name="name" />
                             ...
                             <div class="col-lg-4">
                              ...
                              <div class="col-lg-4">
                                ...
                                <select name="subtype" id="subtype" class="form-control">
                                    <option value="Choose">Choose subtype</option>
                                    <option value="religious">religious</option>
                                    <option value="archaeological find,">archaeological find</option>
                                </select>
                           	 ...
                           	 <div class="col-lg-4">
                           	 	<div class="control-group">
                                <input type="text" class="form-control" id="datecreated" placeholder=" Date Created" name="datecreated" />
                           	 ...
                           	 <div class="col-lg-4">
                           	 	<div class="control-group">
                                <input type="text" class="form-control" id="location" placeholder="Heritage Location" name="location" />
                             ...
                             <div class="col-lg-4">
                                ...
                                <select name="conditions" id="conditions" class="form-control">
                                    <option value="Choose">Choose Conditions</option>
                                ...
                                <select name="Importance" id="Importance" class="form-control">
                                    <option value="Choose">Choose Importance</option>
                                    <option value="Local">Local</option>
                                    <option value="National">National</option>
                                    <option value="International">International</option>
                                </select>
                                <p class="text-danger mt-1" id="error-7" style="font-size:12px;"></p>
                            </div>
                              </div>

                              <div class="col-lg-4">
                                <div class="control-group">
                                <textarea class="form-control" rows="2" id="history" name="history" ></textarea>
                               <p class="text-danger mt-1" id="error-8" style="font-size:12px;"></p>
                            </div> 
                              </div>
                              ...
                              <div class="col-lg-4">
                                ...
                                <p class="text-danger mt-1" id="error-9" style="font-size:12px;"></p>
                            </div>
                              </div>
                            ...
                            <div>
                                <button class="btn btn-primary py-2 px-4" type="submit" id="reg_HeritageBtn" style="border-radius: 0;" name="reg_HeritageBtn">Submit</button>
                            </div>
                        </form>
                    </div>
                </div>
...
<!-- Footer Start -->
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            // body...
            $("#reg_HeritageBtn").on('click',function(event) {
                // body...
                var name = $("#name").val();
                var type = $("#type").val();
                ...
                if (name == '') {
                    ...
                    $("#reg_HeritageBtn").html('Processing...');
                    setTimeout(()=>{
                        $("#reg_HeritageBtn").html('Submit');
                    },1000); 
                }else{
                ...
                if (type == 'Choose') {
                    ...
                    $("#type").removeClass("bg-danger");
                    $("#error-2").html('');
                }

                if (subtype == 'Choose') {
                    event.preventDefault();
                    $("#subtype").css("border-color","red");
                    $("#subtype").addClass("bg-danger");
                    ...
                    $("#subtype").css("border-color","green");
                    $("#subtype").removeClass("bg-danger");
                    $("#error-3").html('');
                }

                if (datecreated == '') {
                    event.preventDefault();
                    $("#datecreated").css("border-color","red");
                    $("#datecreated").addClass("bg-danger");
                    ...
                    $("#datecreated").css("border-color","green");
                    $("#datecreated").removeClass("bg-danger");
                    $("#error-4").html('');
                }
                ...
                if (location == '') {
                    ...
                    $("#location").removeClass("bg-danger");
                    $("#error-5").html('');
                }

                if (conditions == 'Choose') {
                    event.preventDefault();
                    $("#conditions").css("border-color","red");
                    $("#conditions").addClass("bg-danger");
                    ...
                    $("#conditions").css("border-color","green");
                    $("#conditions").removeClass("bg-danger");
                    $("#error-6").html('');
                }

                if (Importance == 'Choose') {
                    event.preventDefault();
                    $("#Importance").css("border-color","red");
                    $("#Importance").addClass("bg-danger");
                    $("#error-7").html('This field is required.');
                    $("#reg_HeritageBtn").html('Processing...');
                    setTimeout(()=>{
                        $("#reg_HeritageBtn").html('Submit');
                    },1000); 
                }else{
                    $("#Importance").css("border-color","green");
                    // $("#type").addClass("bg-success");
                    $("#Importance").removeClass("bg-danger");
                    $("#error-7").html('');
                }

                if (history == '') {
                    event.preventDefault();
                    $("#history").css("border-color","red");
                    $("#history").addClass("bg-danger");
                    $("#error-8").html('This field is required.');
                    $("#reg_HeritageBtn").html('Processing...');
                    setTimeout(()=>{
                        $("#reg_HeritageBtn").html('Submit');
                    },1000); 
                }else{
                    $("#history").css("border-color","green");
                    $("#history").removeClass("bg-danger");
                    $("#error-8").html('');
                }
                ...
                if (file == '') {
                    ...
                    $("#file").addClass("bg-danger");
                    $("#error-9").html('This field is required.');
                    $("#reg_HeritageBtn").html('Processing...');
                    setTimeout(()=>{
                        $("#reg_HeritageBtn").html('Submit');
                    },1000); 
