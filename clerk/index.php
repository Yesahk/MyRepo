            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="card">
                      ...
                      <div class="card-body">
                        ...
                        <a href="reg-heritage.php" class="nav-item nav-link active" style="border-radius: 0;">Register Heritage</a>
                        <a href="listof-heritage.php" class="nav-item nav-link active" style="border-radius: 0;">Heritage List</a>
                        <a href="reg-tourist-flow.php" class="nav-item nav-link active" style="border-radius: 0;">Register tourist flow</a>
                        <a href="listof-tourflow.php" class="nav-item nav-link active" style="border-radius: 0;">Tourist flow List</a>
                ...
                <div class="col-lg-4">
                    <div class="card">
                      ...
                      <div class="card-body">
                        <!-- <h5 class="card-title">Login us Administrator</h5> -->
                        <p class="card-text">Register Heritage</p>
                        <p class="card-text">Register tourist flow</p>
                        <p class="card-text">View income</p>
