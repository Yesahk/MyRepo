    ...
    <div class="container-fluid pt-5">
        <div class="container">
            <div class="text-center pb-2">
                <p class="section-title px-5"><span class="px-2">List of heritages</span></p>
                <h1 class="mb-4">List of heritages</h1>
                <p class="text-primary List of heritagestext-center" style="font-size:13px;"><?= $cObject->HeritageMethod(); ?></p>
            </div>
                                        ...
                                        <?php
                                          if ($value['status'] == 1) { ?>
                                             <form action="" method="post">
                                                ...
                                                <input type="submit" name="Active" value="Open for Tourism" class="btn btn-success" style="border-radius:0; height:28px; font-size: 10px;">
                                            </form>
                                       <?php  }else{  ?> 
                                            <form action="" method="post">
                                            <input type="hidden" name="hid" value="<?= $value['id']; ?>">
                                            <input type="submit" name="DeAtive" value="Closed for Tourism" class="btn btn-danger" style="border-radius:0; height:28px; font-size: 10px;">
                                          </form>
                                       <?php } ?>
                                         </td>
                                    </tr>
