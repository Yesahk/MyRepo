    ...
    <div class="container-fluid pt-5">
        <div class="container">
            <div class="text-center pb-2">
                <p class="section-title px-5"><span class="px-2"> List of Reserved rooms</span></p>
                <h1 class="mb-4">List of Reserved rooms</h1>
                <p class="text-primary text-center" style="font-size:13px;"><?=$vObject->replaceRoom(); ?></p>
            </div>
                ...
                <div class="col-lg-12 col-sm-12">
                    <div class="table-responsive">
                        <table class="table table-borederd">
                            ...
                            <?php
                                $dataQ = $vObject->getReservedRooms($_SESSION['sessionemail']);
                                $rowQ= $vObject->getReservedRooms($_SESSION['sessionemail']);
                                if ($rowQ > 0) {
                                    $x = 0;
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="" method="post">
                                                <input type="hidden" name="ruid" value="<?= $value['roomid']; ?>">
                                                <input type="hidden" name="roomnumber" value="<?= $value['roomnumber']; ?>">
                                                <input type="hidden" name="email" value="<?= $_SESSION['sessionemail']; ?>">
                                                <input type="submit" name="Replace" value="Replace" class="btn btn-success" style="border-radius:0; height:28px; font-size: 10px;">
                                            </form>
                                        </td>
                                    </tr>
