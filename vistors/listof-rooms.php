    ...
    <div class="container-fluid pt-5">
        <div class="container">
            <div class="text-center pb-2">
                <p class="section-title px-5"><span class="px-2"> List of rooms</span></p>
                ...
                <div class="col-lg-12 col-sm-12">
                    <div class="table-responsive">
                        <table class="table table-borederd">
                            ...
                            <?php
                                $dataQ = $vObject->getMyRooms();
                                $rowQ= $vObject->getMyRooms();
                                if ($rowQ > 0) {
                                    $x = 0;
                                    ...
                                    <tr>
                                        ...
                                        <?php
                                          if ($value['status'] == 1) { ?>
                                                ...
                                                <input type="submit" name="Active" value="Reserved" class="btn btn-success" style="border-radius:0; height:28px; font-size: 10px;">
                                       <?php  }else{  ?> 
                                            <a type="submit" name="DeAtive" value="Not Reserved" class="btn btn-primary" style="border-radius:0; height:28px; font-size: 10px;" href="reserveroom.php?rid=<?=$value['roomid']; ?>&n=<?=$value['roomnumber']; ?>&name=<?=$value['hname']; ?>">Reserve Here</a>
                                       <?php } ?>
                                         </td>
                                    </tr>
