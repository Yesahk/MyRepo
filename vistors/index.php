<?php 
 ...
 require __DIR__.'/vistors_class.php';
 $vObject = new vistorsClass();

 $dataQ = $vObject->getDetail($_SESSION['sessionemail']);
 $rowQ = $vObject->getDetail($_SESSION['sessionemail']);
                ...
                <div class="col-lg-4">
                    <div class="card">
                      ...
                      <div class="card-body">
                        ...
                        <p class="card-text">Reserve rooms</p>
