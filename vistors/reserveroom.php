    ...
    <div class="container-fluid pt-5">
        <div class="container">
            <div class="text-center pb-2">
                <p class="section-title px-5"><span class="px-2">Reseve room</span></p>
                ...
                <div class="col-lg-6">
                    <div class="contact-form">
                        ...
                        <form id="forms" action="" method="post">
                            ...
                            <p class="text-primary text-center" style="font-size:14px;"><?=$vObject->Reservation(); ?></p>
                            ...
                            <div class="control-group">
                                <input type="text" class="form-control" id="roomnumber"  name="roomnumber" value="<?=$_GET['n']; ?>" />
                                <input type="hidden" class="form-control" id="roomnumber"  name="ruid" value="<?=$_GET['rid']; ?>" />
                                <input type="hidden" class="form-control" id="roomnumber"  name="name" value="<?=$_GET['name']; ?>" />
                            ...
                            <div>
                                <button class="btn btn-primary py-2 px-4" type="submit" id="changeBtn" style="border-radius: 0;" name="Reserved">Reserve</button>
                            </div>
                        </form>
                    </div>
                </div>
